...
export const seedClients: Client[] = [
    { id: 'c1', name: 'Sarah Mitchell', email: 'sarah@mitchell-interiors.com', phone: '+1-555-0101', company: 'Mitchell Interiors', status: 'active', projectCount: 4, createdAt: '2025-03-15', lastActivity: '2026-02-10', avatar: 'https://i.pravatar.cc/150?u=c1' },
    { id: 'c2', name: 'James Thornton', email: 'james@thornton-dev.com', phone: '+1-555-0102', company: 'Thornton Development', status: 'active', projectCount: 3, createdAt: '2025-04-20', lastActivity: '2026-02-09', avatar: 'https://i.pravatar.cc/150?u=c2' },
    { id: 'c3', name: 'Elena Rodriguez', email: 'elena@casa-moderna.com', phone: '+1-555-0103', company: 'Casa Moderna', status: 'active', projectCount: 3, createdAt: '2025-05-10', lastActivity: '2026-02-08', avatar: 'https://i.pravatar.cc/150?u=c3' },
    { id: 'c4', name: 'David Chen', email: 'david@chenarchitects.com', phone: '+1-555-0104', company: 'Chen Architects', status: 'active', projectCount: 2, createdAt: '2025-06-01', lastActivity: '2026-02-07', avatar: 'https://i.pravatar.cc/150?u=c4' },
    { id: 'c5', name: 'Priya Sharma', email: 'priya@luxe-spaces.com', phone: '+1-555-0105', company: 'Luxe Spaces', status: 'active', projectCount: 3, createdAt: '2025-06-15', lastActivity: '2026-02-06', avatar: 'https://i.pravatar.cc/150?u=c5' },
    { id: 'c6', name: 'Marcus Williams', email: 'marcus@urban-loft.com', phone: '+1-555-0106', company: 'Urban Loft Co', status: 'active', projectCount: 2, createdAt: '2025-07-01', lastActivity: '2026-02-05', avatar: 'https://i.pravatar.cc/150?u=c6' },
    { id: 'c7', name: 'Olivia Parker', email: 'olivia@parker-homes.com', phone: '+1-555-0107', company: 'Parker Homes', status: 'active', projectCount: 2, createdAt: '2025-07-20', lastActivity: '2026-02-04', avatar: 'https://i.pravatar.cc/150?u=c7' },
    { id: 'c8', name: 'Robert Kim', email: 'robert@eliteprops.com', phone: '+1-555-0108', company: 'Elite Properties', status: 'inactive', projectCount: 1, createdAt: '2025-08-05', lastActivity: '2026-01-15', avatar: 'https://i.pravatar.cc/150?u=c8' },
    { id: 'c9', name: 'Nadia Al-Rashid', email: 'nadia@arabesque-design.com', phone: '+1-555-0109', company: 'Arabesque Design', status: 'active', projectCount: 2, createdAt: '2025-08-20', lastActivity: '2026-02-03', avatar: 'https://i.pravatar.cc/150?u=c9' },
    { id: 'c10', name: 'Thomas Baker', email: 'thomas@bakergroup.com', phone: '+1-555-0110', company: 'Baker Group', status: 'active', projectCount: 1, createdAt: '2025-09-01', lastActivity: '2026-02-01', avatar: 'https://i.pravatar.cc/150?u=c10' },
    { id: 'c11', name: 'Isabella Costa', email: 'isabella@costastudio.com', phone: '+1-555-0111', company: 'Costa Studio', status: 'inactive', projectCount: 1, createdAt: '2025-09-15', lastActivity: '2025-12-20', avatar: 'https://i.pravatar.cc/150?u=c11' },
    { id: 'c12', name: 'Andrew Foster', email: 'andrew@foster-build.com', phone: '+1-555-0112', company: 'Foster Build LLC', status: 'active', projectCount: 1, createdAt: '2025-10-01', lastActivity: '2026-02-11', avatar: 'https://i.pravatar.cc/150?u=c12' },
];

// ===== DESIGNERS (10) =====
export const seedDesigners: Designer[] = [
    { id: 'd1', name: 'Alex Rivera', email: 'alex@drafthause.com', phone: '+1-555-0201', status: 'active', skills: ['3D Modeling', 'Interior Design', 'LiDAR Scanning'], projectsAssigned: 6, versionsCreated: 18, lastActivity: '2026-02-11', createdAt: '2025-01-10', bio: 'Senior spatial designer with 8 years of experience in residential and commercial projects.', avatar: 'https://i.pravatar.cc/150?u=d1' },
    { id: 'd2', name: 'Maya Johnson', email: 'maya@drafthause.com', phone: '+1-555-0202', status: 'active', skills: ['Floor Planning', 'Interior Design', 'Color Theory'], projectsAssigned: 5, versionsCreated: 14, lastActivity: '2026-02-10', createdAt: '2025-02-15', bio: 'Specializes in modern residential spaces and sustainable design.', avatar: 'https://i.pravatar.cc/150?u=d2' },
    { id: 'd3', name: 'Ryan O\'Brien', email: 'ryan@drafthause.com', phone: '+1-555-0203', status: 'active', skills: ['3D Modeling', 'Commercial Spaces', 'CAD'], projectsAssigned: 4, versionsCreated: 11, lastActivity: '2026-02-09', createdAt: '2025-03-01', bio: 'Expert in commercial space optimization using LiDAR technology.', avatar: 'https://i.pravatar.cc/150?u=d3' },
    { id: 'd4', name: 'Sofia Nguyen', email: 'sofia@drafthause.com', phone: '+1-555-0204', status: 'active', skills: ['Interior Design', 'Furniture Layout', 'Lighting'], projectsAssigned: 4, versionsCreated: 12, lastActivity: '2026-02-08', createdAt: '2025-03-20', bio: 'Creative designer focused on luxury residential interiors.', avatar: 'https://i.pravatar.cc/150?u=d4' },
    { id: 'd5', name: 'Daniel Kim', email: 'daniel@drafthause.com', phone: '+1-555-0205', status: 'active', skills: ['3D Scanning', 'Measurement', 'Technical Drawing'], projectsAssigned: 3, versionsCreated: 9, lastActivity: '2026-02-07', createdAt: '2025-04-10', bio: 'Technical specialist in LiDAR scanning and precision measurements.', avatar: 'https://i.pravatar.cc/150?u=d5' },
    { id: 'd6', name: 'Emma Watson', email: 'emma@drafthause.com', phone: '+1-555-0206', status: 'active', skills: ['Space Planning', 'Material Selection', 'Visualization'], projectsAssigned: 3, versionsCreated: 8, lastActivity: '2026-02-06', createdAt: '2025-05-01', bio: 'Experienced in both residential and commercial renovation projects.', avatar: 'https://i.pravatar.cc/150?u=d6' },
    { id: 'd7', name: 'Hassan Ahmed', email: 'hassan@drafthause.com', phone: '+1-555-0207', status: 'active', skills: ['3D Modeling', 'Rendering', 'Animation'], projectsAssigned: 2, versionsCreated: 6, lastActivity: '2026-02-05', createdAt: '2025-06-01', bio: 'Specialist in photorealistic 3D visualizations.', avatar: 'https://i.pravatar.cc/150?u=d7' },
    { id: 'd8', name: 'Chloe Martin', email: 'chloe@drafthause.com', phone: '+1-555-0208', status: 'active', skills: ['Interior Design', 'Staging', 'Color Consulting'], projectsAssigned: 2, versionsCreated: 5, lastActivity: '2026-02-03', createdAt: '2025-07-15', bio: 'Home staging expert with an eye for contemporary aesthetics.', avatar: 'https://i.pravatar.cc/150?u=d8' },
    { id: 'd9', name: 'Lucas Brown', email: 'lucas@drafthause.com', phone: '+1-555-0209', status: 'inactive', skills: ['CAD', 'Drafting', 'Blueprint'], projectsAssigned: 1, versionsCreated: 3, lastActivity: '2025-12-10', createdAt: '2025-08-01', bio: 'Technical drafter specializing in detailed floor plans.', avatar: 'https://i.pravatar.cc/150?u=d9' },
    { id: 'd10', name: 'Amara Okafor', email: 'amara@drafthause.com', phone: '+1-555-0210', status: 'active', skills: ['3D Modeling', 'Interior Design', 'Sustainability'], projectsAssigned: 2, versionsCreated: 4, lastActivity: '2026-02-01', createdAt: '2025-09-01', bio: 'Designer passionate about sustainable and eco-friendly spaces.', avatar: 'https://i.pravatar.cc/150?u=d10' },
];
...
export const seedProducts: ProductItem[] = [
    { id: 'prod1', name: 'Aria Modular Sofa', brand: 'Restoration Hardware', sku: 'RH-AMS-001', category: 'Furniture', supplier: 'Restoration Hardware', leadTime: '6-8 weeks', dimensions: '280 x 100 x 75 cm', sourceUrl: 'https://rh.com/aria-modular', imageUrl: 'https://images.unsplash.com/photo-1555041469-a586c61ea9bc?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod2', name: 'Executive Leather Chair', brand: 'Herman Miller', sku: 'HM-ELC-002', category: 'Furniture', supplier: 'Herman Miller', leadTime: '3-4 weeks', dimensions: '65 x 65 x 110 cm', imageUrl: 'https://images.unsplash.com/photo-1505843490538-5133c6c7d0e1?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod3', name: 'Scandinavian Accent Chair', brand: 'Fritz Hansen', sku: 'FH-SAC-003', category: 'Furniture', supplier: 'Fritz Hansen', leadTime: '4-6 weeks', dimensions: '70 x 70 x 80 cm', imageUrl: 'https://images.unsplash.com/photo-1598300042247-d088f8ab3a91?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod4', name: 'Marble Console Table', brand: 'CB2', sku: 'CB2-MCT-004', category: 'Furniture', supplier: 'CB2', leadTime: '2-3 weeks', dimensions: '120 x 35 x 80 cm', imageUrl: 'https://images.unsplash.com/photo-1532372320572-cda25653a26d?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod5', name: 'Standing Conference Table', brand: 'Steelcase', sku: 'SC-SCT-005', category: 'Furniture', supplier: 'Steelcase', leadTime: '4-6 weeks', dimensions: '240 x 120 x 110 cm', imageUrl: 'https://images.unsplash.com/photo-1611269154421-4e27233ac5c7?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod6', name: 'Sculptural Pendant Light', brand: 'Flos', sku: 'FL-SPL-006', category: 'Lighting', supplier: 'Flos', leadTime: '3-5 weeks', dimensions: '50 x 50 x 60 cm', imageUrl: 'https://images.unsplash.com/photo-1513506003013-1b6a511ffa68?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod7', name: 'Linear Track Lighting', brand: 'Bega', sku: 'BG-LTL-007', category: 'Lighting', supplier: 'Bega', leadTime: '2-4 weeks', dimensions: '120 x 8 x 12 cm', imageUrl: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod8', name: 'Walnut Bookshelf System', brand: 'USM', sku: 'USM-WBS-008', category: 'Furniture', supplier: 'USM', leadTime: '6-8 weeks', dimensions: '200 x 40 x 220 cm', imageUrl: 'https://images.unsplash.com/photo-1594620302200-9a762244a156?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod9', name: 'Hand-Knotted Persian Rug', brand: 'Restoration Hardware', sku: 'RH-HPR-009', category: 'Textiles', supplier: 'Restoration Hardware', leadTime: '8-12 weeks', dimensions: '300 x 200 cm', imageUrl: 'https://images.unsplash.com/photo-1575414003591-ece8d0416c7a?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod10', name: 'Commercial Floor Tile', brand: 'Porcelanosa', sku: 'PO-CFT-010', category: 'Flooring', supplier: 'Porcelanosa', leadTime: '1-2 weeks', dimensions: '60 x 60 cm', imageUrl: 'https://images.unsplash.com/photo-1620626011761-0f74a05553ee?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod11', name: 'Ceramic Vase Collection', brand: 'Jonathan Adler', sku: 'JA-CVC-011', category: 'Wall Decor', supplier: 'Jonathan Adler', leadTime: '1-2 weeks', dimensions: '15 x 15 x 30 cm', imageUrl: 'https://images.unsplash.com/photo-1581783342308-f792ca11df53?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod12', name: 'Brass Wall Sconce', brand: 'Visual Comfort', sku: 'VC-BWS-012', category: 'Lighting', supplier: 'Visual Comfort', leadTime: '3-5 weeks', dimensions: '15 x 12 x 25 cm', imageUrl: 'https://images.unsplash.com/photo-1507473888900-52e1ad14db15?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod13', name: 'Live Edge Dining Table', brand: 'West Elm', sku: 'WE-LDT-013', category: 'Furniture', supplier: 'West Elm', leadTime: '4-6 weeks', dimensions: '200 x 100 x 76 cm', imageUrl: 'https://images.unsplash.com/photo-1577140917170-285929fb55b7?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod14', name: 'Velvet Throw Pillow Set', brand: 'West Elm', sku: 'WE-VTP-014', category: 'Textiles', supplier: 'West Elm', leadTime: '1 week', dimensions: '50 x 50 cm', imageUrl: 'https://images.unsplash.com/photo-1584100936595-c0654b55a2e2?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod15', name: 'Filing Cabinet System', brand: 'Steelcase', sku: 'SC-FCS-015', category: 'Furniture', supplier: 'Steelcase', leadTime: '2-3 weeks', dimensions: '45 x 60 x 100 cm', imageUrl: 'https://images.unsplash.com/photo-1524758631624-e2822e304c36?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod16', name: 'Abstract Wall Art', brand: 'Minted', sku: 'MT-AWA-016', category: 'Wall Decor', supplier: 'Minted', leadTime: '1-2 weeks', dimensions: '90 x 120 cm', imageUrl: 'https://images.unsplash.com/photo-1579783902614-a3fb3927b6a5?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod17', name: 'Oak Side Table', brand: 'Article', sku: 'AR-OST-017', category: 'Furniture', supplier: 'Article', leadTime: '2-3 weeks', dimensions: '45 x 45 x 55 cm', imageUrl: 'https://images.unsplash.com/photo-1533090481720-856c6e3c1fdc?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod18', name: 'Lounge Chair', brand: 'Knoll', sku: 'KN-LC-018', category: 'Furniture', supplier: 'Knoll', leadTime: '6-8 weeks', dimensions: '80 x 85 x 80 cm', imageUrl: 'https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod19', name: 'Smart LED Panel', brand: 'Philips Hue', sku: 'PH-SLP-019', category: 'Lighting', supplier: 'Philips', leadTime: '1 week', dimensions: '60 x 60 x 5 cm', imageUrl: 'https://plus.unsplash.com/premium_photo-1670359039867-b52c00c735d4?auto=format&fit=crop&q=80&w=800' },
    { id: 'prod20', name: 'Entryway Storage Bench', brand: 'Crate & Barrel', sku: 'CB-ESB-020', category: 'Furniture', supplier: 'Crate & Barrel', leadTime: '3-4 weeks', dimensions: '120 x 40 x 50 cm', imageUrl: 'https://images.unsplash.com/photo-1595428774223-ef52624120d2?auto=format&fit=crop&q=80&w=800' },
];
